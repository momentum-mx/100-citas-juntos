...
const Hero = () => {
  return (
    <section className="relative min-h-screen gradient-hero flex items-center pt-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-rose to-rose-light border-2 border-background flex items-center justify-center shadow-soft"
                  >
          ...
          >
            ...
            >
              <img
                src={product100Citas}
                alt="100 Citas Juntos - Libro de experiencias románticas"
